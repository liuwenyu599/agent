...
请据此撰写，不要输出解释性文字，直接给公文正文。"""
    ...
    def chat(self, message: str, history: List[Dict], sources: List[Dict], user_role: str, memories: List[Dict] = None, examples: list = None, system_prompt: str = None, template_category: str = None) -> str:
        """主对话入口"""
